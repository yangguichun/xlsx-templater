(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('exceljs'), require('node-fetch'), require('lodash/cloneDeep')) :
  typeof define === 'function' && define.amd ? define(['exceljs', 'node-fetch', 'lodash/cloneDeep'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.XlsxTemplater = factory(global.ExcelJS, global.fetch, global._.cloneDeep));
})(this, (function (ExcelJS, fetch, cloneDeep) { 'use strict';
  ...
  class ImageUtil{
    ...
    static getImageData(url){
      ...
      return new Promise((resolve, reject)=>{
        ...
        fetch__default["default"](url).then((res) => {
          res.blob().then((blob) => {
        ...
        for(let i = 0; i<worksheet.conditionalFormattings.length; i++){
          ...
          if(ExcelUtil._getConditionFormatterRowIndex(cd) == rowIndex){
            for(let j = 0; j < count; j++){
              let newCd = cloneDeep__default["default"](cd);          
